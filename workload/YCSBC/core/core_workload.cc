...
const string CoreWorkload::LOG_PATH_PROPERTY = "logpath";
const string CoreWorkload::LOG_PATH_DEFAULT = "result.log";

const string CoreWorkload::RECORD_TIME_INTERVAL_PROPERTY = "recordinterval";
const string CoreWorkload::RECORD_TIME_INTERVAL_DEFAULT = "100";

const string CoreWorkload::THREADS_NUM_PROPERTY = "threads";
const string CoreWorkload::THREADS_NUM_DEFAULT = "2";

const string CoreWorkload::DB_NAME_PROPERTY = "dbname";
const string CoreWorkload::DB_NAME_DEFAULT = "lock_stl";
...
void CoreWorkload::Init(const utils::Properties &p) {
  ...
  threads_num = std::stoi(p.GetProperty(THREADS_NUM_PROPERTY, THREADS_NUM_DEFAULT));
  db_name = p.GetProperty(DB_NAME_PROPERTY, DB_NAME_DEFAULT);
  log_path = p.GetProperty(LOG_PATH_PROPERTY, LOG_PATH_DEFAULT);
  record_interval = std::stoi(p.GetProperty(READ_PROPORTION_PROPERTY, 
                                            READ_ALL_FIELDS_DEFAULT));
