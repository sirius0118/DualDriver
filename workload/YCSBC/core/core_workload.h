...
class CoreWorkload {
 public:
  ...
  static const std::string LOG_PATH_PROPERTY;
  static const std::string LOG_PATH_DEFAULT;

  static const std::string RECORD_TIME_INTERVAL_PROPERTY;
  static const std::string RECORD_TIME_INTERVAL_DEFAULT;

  static const std::string THREADS_NUM_PROPERTY;
  static const std::string THREADS_NUM_DEFAULT;

  static const std::string DB_NAME_PROPERTY;
  static const std::string DB_NAME_DEFAULT;
  ///
